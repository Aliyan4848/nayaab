          ...
          <Container>
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              {categories.map((c) => {
                ...
                return (
                  <Link key={c.slug} href={`/fabric/${c.slug}`} className="group relative block aspect-[3/4]">
                    <Image
                      src={imageUrl}
                      alt={c.name}
                      fill
                    ...
                    <p className="absolute bottom-5 left-5 font-serif text-xl text-ivory">{c.name}</p>
                  </Link>
                );
              })}
            </div>
